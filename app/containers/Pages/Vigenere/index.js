...
class Vigenere extends React.Component {
  ...
  descipher() {
    ...
    post(webUrlBase + 'classics/VigenereDescipher', data).then((json) => {
  ...
  generateKey() {
    ...
    post(webUrlBase + 'classics/VigenereGeneratePassword', data).then((json) => {
  ...
  render() {
    ...
    return (
      <div>
        <PapperBlock title="Vigenere" desc="">
