...
class Permutation extends React.Component {
  ...
  cipher() {
    ...
    post(webUrlBase + 'classics/PermutationCipher', data).then((json) => {
  ...
  descipher() {
    ...
    post(webUrlBase + 'classics/PermutationDescipher', data).then((json) => {
  ...
  generateKey() {
    ...
    post(webUrlBase + 'classics/PermutationGeneratePassword', data).then((json) => {
