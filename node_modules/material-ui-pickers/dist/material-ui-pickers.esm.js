...
import { oneOfType, object, string, number, instanceOf, func, element, arrayOf, bool, any, shape, node, oneOf } from 'prop-types';
...
var ModalDialog = function (_a) {
  ...
  return createElement(Dialog, __assign({
    ...
    onClose: onDismiss,
    classes: {
      paper: clsx(classes.dialogRoot, (_b = {}, _b[classes.dialogWithTabs] = showTabs, _b))
    }
...
var SlideTransition = function (_a) {
  ...
  return createElement(TransitionGroup, {
    ...
    childFactory: function (element$$1) {
      return cloneElement(element$$1, {
...
function (_super) {
  ...
  Day.prototype.render = function () {
    ...
    var className = clsx(classes.day, (_a = {}, _a[classes.hidden] = hidden, _a[classes.current] = current, _a[classes.selected] = selected, _a[classes.disabled] = disabled, _a));
