...
class UserMenu extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        {
        // SE COMENTO ESTA PARTE POR SI SE QUIERE USAR NOTIFICAIONES EN UN FUTURO
        /* <IconButton
          aria-haspopup="true"
        ...
        >
          {
            /* <MenuItem onClick={this.handleClose} component={Link} to={link.profile}>Mi Perfil</MenuItem>
            <MenuItem onClick={this.handleClose} component={Link} to={link.calendar}>Calendario</MenuItem>
          ...
          <MenuItem onClick={this.handleCloseSession} component={Link} to="/">
            <ListItemIcon>
              <ExitToApp />
            </ListItemIcon>
            Salir
